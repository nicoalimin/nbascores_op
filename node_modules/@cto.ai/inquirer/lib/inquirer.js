...
inquirer.createPromptModule = function(opt) {
  ...
  promptModule.restoreDefaultPrompts = function() {
    ...
    this.registerPrompt('datepicker', require('./prompts/datetime'));
    this.registerPrompt('autocomplete', require('./prompts/autocomplete'));
    this.registerPrompt('checkbox-plus', require('./prompts/checkbox-plus'));
    this.registerPrompt('emoji', require('./prompts/emoji'));
    this.registerPrompt('fuzzypath', require('./prompts/fuzzy-path'));
  };
